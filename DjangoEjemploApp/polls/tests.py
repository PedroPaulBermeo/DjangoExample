...
#TestCase Es una clase que viene del modulo test
#que nos permite definir una bateria de test
#Una bateria de Tests es un conjunto de test que se
#Corresponden a un aspecto en particular de nuestra APP

#Models
#Vistas
#Se puede testear mas cosas pero estas 2 son las mas comunes

class QuesionModelTests(TestCase):

    def test_was_published_recently_with_future_question(self):
        '''was_publiced_recently return False for questions whose pub_date is in the future'''
...
def create_question(question_text, days):
    ...
    number of days offset to now (negative questions published in the past,
...
class QuestionIndexViewTest(TestCase):
    ...
    #Challenge no vuelva a pasar el bug de aparecer preguntas creadas a futuro
    ...
    def test_past_question(self):
        """
        Question with the pub_date in the past are displayed on the index page.
        """
